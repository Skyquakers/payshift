...
export interface IPaymentProvidable {
  ...
  createPaymentQrcodeUrl?: (
    charge: ChargeCreateParams,
    notifyUrl?: string
  ) => Promise<string>
  createMobilePaymentLink?: (
    charge: ChargeCreateParams,
    notifyUrl?: string
  ) => Promise<string>
}

export type ClassImplements<I, ConstructorArgs extends any[] = any[]> = new (
  ...args: ConstructorArgs
) => I

export type PayshiftEventName =
...
export type PayshiftProviderName =
  | 'alipay'
  | 'wechat_pay'
  | 'stripe'
  | 'paypal'
